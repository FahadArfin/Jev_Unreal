...
REPORT = ARTIFACTS / "mesh-workflows-v0.8.json"
DIAGNOSTICS = ARTIFACTS / "mesh-workflows-v0.8-diagnostics.json"
...
async def capture(session, paths, stage):
    ...
    target = ARTIFACTS / f"mesh-workflow-v0.8-{stage}.png"
