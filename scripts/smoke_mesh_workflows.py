...
REPORT = ARTIFACTS / "mesh-workflows-v0.7.json"
DIAGNOSTICS = ARTIFACTS / "mesh-workflows-v0.7-diagnostics.json"
...
async def capture(session, paths, stage):
    ...
    target = ARTIFACTS / f"mesh-workflow-v0.7-{stage}.png"
